SELECT 
    XMLElement("Modelo_Aplicacion_LADMCOL_RIC_V0_1.RIC.RIC_Derecho", XMLAttributes(sys_guid() as "TID"),
        XMLElement("id", ppp.id),
        XMLElement("Tipo", DECODE(
            ppp.tipo,
            'PROPIETARIO', 'Dominio',
            'Otro'
        )),
        XMLElement("Fraccion_Derecho", ''),
        XMLElement("Espacio_De_Nombres", 'RIC_DERECHO'),
